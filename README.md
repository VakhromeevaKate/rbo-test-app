# RBO TEST APP
## Тестовое Задание на позицию Frontend Engineer Инструменты:  
ReactJS 
### Входные данные: 
data-attributes.csv Формат: ID, значение; 
data-colors.csv - Формат: ID цвета, у каких авто цвет; 
data-auto.csv - Формат: ID, марка, модель, тип кузова, год выпуска, ISO код страны; data-options.csv - Формат: ID Опции, в каких авто присутствует; 
data-countries.csv - Формат: ISO код страны, полное название страны.
### Задание:  
• Обработать входные данные и составить из них модель; 
• Сделать табличное представление из входных данных; 
• Добавить возможность группировки данных по марке, типу кузова; 
• По клику на строку таблицы показать детальное описание (год выпуска, цвет, страну, опции); 
• Показать в детальном описании похожие авто (2 и более совпадающих атрибута (цвет, тип кузова, опции); 
• Реализовать сортировку по марке, году, типу кузова;  
• Реализовать поиск.
